...
object AggregateRootCheck:
  ...
  inline def checkElem[T](): Unit =
    inline erasedValue[T] match
      case _: AggregateRootEntity[_] => error("AggregateRoot can't have another AggregateRoot")
      case _ => ()
  ...
  inline given derived[T <: AggregateRootEntity[_]](using ev: Mirror.Of[T]): AggregateRootCheck[T] =
